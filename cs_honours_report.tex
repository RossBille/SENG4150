...
The state of a system refers to the data and processes that live in that state. The state within conventional operating systems exists in a transistent manner, this means that if a failure occurs the state can cease to exist. In a perfect world this would not matter however we do not live in a perfect world. The world is full of inconsistencies such as:
\begin{itemize}
    \item{Power failures}
